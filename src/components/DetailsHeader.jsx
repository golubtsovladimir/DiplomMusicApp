...
const DetailsHeader = ({songData , artistData, artistId}) => {
    ...
    <div className="relative w-full flex flex-col">
      <div className="w-full bg-gradient-to-l from-transparent to-[#0075FF] sm:h-52 h-28">
          ...
          <div className="ml-5">
            ...
            {!artistId && ( 
              <Link to={`/artists/${shazamArtistId}`}>
                <p className=" text-black mt-2 font-bold text-xl">{shazamArtist.attributes.name}</p>
